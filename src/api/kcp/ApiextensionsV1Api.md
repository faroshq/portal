...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition createApiextensionsV1CustomResourceDefinition(body)
...
let body:.ApiextensionsV1ApiCreateApiextensionsV1CustomResourceDefinitionRequest = {
          ...
          schema: {
            openAPIV3Schema: {
              ...
              xKubernetesListMapKeys: [
                "xKubernetesListMapKeys_example",
              ],
              xKubernetesListType: "xKubernetesListType_example",
              xKubernetesMapType: "xKubernetesMapType_example",
...
apiInstance.createApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
...
> IoK8sApimachineryPkgApisMetaV1Status deleteApiextensionsV1CollectionCustomResourceDefinition()
...
let body:.ApiextensionsV1ApiDeleteApiextensionsV1CollectionCustomResourceDefinitionRequest = {
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.deleteApiextensionsV1CollectionCustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteApiextensionsV1CustomResourceDefinition()
...
let body:.ApiextensionsV1ApiDeleteApiextensionsV1CustomResourceDefinitionRequest = {
...
apiInstance.deleteApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
apiInstance.getApiextensionsV1APIResources(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList listApiextensionsV1CustomResourceDefinition()
...
let body:.ApiextensionsV1ApiListApiextensionsV1CustomResourceDefinitionRequest = {
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.listApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition patchApiextensionsV1CustomResourceDefinition(body)
...
let body:.ApiextensionsV1ApiPatchApiextensionsV1CustomResourceDefinitionRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition patchApiextensionsV1CustomResourceDefinitionStatus(body)
...
let body:.ApiextensionsV1ApiPatchApiextensionsV1CustomResourceDefinitionStatusRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // any
  body: {},
...
apiInstance.patchApiextensionsV1CustomResourceDefinitionStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition readApiextensionsV1CustomResourceDefinition()
...
let body:.ApiextensionsV1ApiReadApiextensionsV1CustomResourceDefinitionRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.readApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition readApiextensionsV1CustomResourceDefinitionStatus()
...
let body:.ApiextensionsV1ApiReadApiextensionsV1CustomResourceDefinitionStatusRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // string | If 'true', then the output is pretty printed. (optional)
  pretty: "pretty_example",
...
apiInstance.readApiextensionsV1CustomResourceDefinitionStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition replaceApiextensionsV1CustomResourceDefinition(body)
...
let body:.ApiextensionsV1ApiReplaceApiextensionsV1CustomResourceDefinitionRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
  body: {
...
apiInstance.replaceApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition replaceApiextensionsV1CustomResourceDefinitionStatus(body)
...
let body:.ApiextensionsV1ApiReplaceApiextensionsV1CustomResourceDefinitionStatusRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition
  body: {
...
apiInstance.replaceApiextensionsV1CustomResourceDefinitionStatus(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchApiextensionsV1CustomResourceDefinition()
...
let body:.ApiextensionsV1ApiWatchApiextensionsV1CustomResourceDefinitionRequest = {
  // string | name of the CustomResourceDefinition
  name: "name_example",
  // boolean | allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. (optional)
  allowWatchBookmarks: true,
...
apiInstance.watchApiextensionsV1CustomResourceDefinition(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.ApiextensionsV1ApiWatchApiextensionsV1CustomResourceDefinitionListRequest = {
  // boolean | allowWatchBookmarks requests watch events with type \"BOOKMARK\". Servers that do not implement bookmarks may ignore this flag and bookmarks are sent at the server's discretion. Clients should not assume bookmarks are returned at any specific interval, nor may they assume the server will send any BOOKMARK event during a session. If this is not a watch, this field is ignored. (optional)
  allowWatchBookmarks: true,
  // string | The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications. (optional)
  _continue: "continue_example",
...
apiInstance.watchApiextensionsV1CustomResourceDefinitionList(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
