...
export class PromiseApiextensionsApi {
     ...
     */
    public getApiextensionsAPIGroup(_options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1APIGroup> {
        const result = this.api.getApiextensionsAPIGroup(_options);
...
export class PromiseApiextensionsV1Api {
     ...
     */
    public createApiextensionsV1CustomResourceDefinition(body: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.createApiextensionsV1CustomResourceDefinition(body, pretty, dryRun, fieldManager, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public deleteApiextensionsV1CollectionCustomResourceDefinition(pretty?: string, _continue?: string, dryRun?: string, fieldSelector?: string, gracePeriodSeconds?: number, labelSelector?: string, limit?: number, orphanDependents?: boolean, propagationPolicy?: string, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, body?: IoK8sApimachineryPkgApisMetaV1DeleteOptions, _options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1Status> {
        const result = this.api.deleteApiextensionsV1CollectionCustomResourceDefinition(pretty, _continue, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body, _options);
        return result.toPromise();
    }
     ...
     * @param body 
     */
    public deleteApiextensionsV1CustomResourceDefinition(name: string, pretty?: string, dryRun?: string, gracePeriodSeconds?: number, orphanDependents?: boolean, propagationPolicy?: string, body?: IoK8sApimachineryPkgApisMetaV1DeleteOptions, _options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1Status> {
        const result = this.api.deleteApiextensionsV1CustomResourceDefinition(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body, _options);
        return result.toPromise();
    }
     ...
     */
    public getApiextensionsV1APIResources(_options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1APIResourceList> {
        const result = this.api.getApiextensionsV1APIResources(_options);
        return result.toPromise();
    }
     ...
     */
    public listApiextensionsV1CustomResourceDefinition(pretty?: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList> {
        const result = this.api.listApiextensionsV1CustomResourceDefinition(pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options);
        return result.toPromise();
    }
     ...
     */
    public patchApiextensionsV1CustomResourceDefinition(name: string, body: any, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.patchApiextensionsV1CustomResourceDefinition(name, body, pretty, dryRun, fieldManager, force, _options);
        return result.toPromise();
    }
     ...
     * @param force Force is going to \&quot;force\&quot; Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
     */
    public patchApiextensionsV1CustomResourceDefinitionStatus(name: string, body: any, pretty?: string, dryRun?: string, fieldManager?: string, force?: boolean, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.patchApiextensionsV1CustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, force, _options);
        return result.toPromise();
    }
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
    public readApiextensionsV1CustomResourceDefinition(name: string, pretty?: string, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.readApiextensionsV1CustomResourceDefinition(name, pretty, _options);
        return result.toPromise();
    }
     ...
     * @param pretty If &#39;true&#39;, then the output is pretty printed.
     */
    public readApiextensionsV1CustomResourceDefinitionStatus(name: string, pretty?: string, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.readApiextensionsV1CustomResourceDefinitionStatus(name, pretty, _options);
        return result.toPromise();
    }
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceApiextensionsV1CustomResourceDefinition(name: string, body: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.replaceApiextensionsV1CustomResourceDefinition(name, body, pretty, dryRun, fieldManager, _options);
        return result.toPromise();
    }
     ...
     * @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
     */
    public replaceApiextensionsV1CustomResourceDefinitionStatus(name: string, body: IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition, pretty?: string, dryRun?: string, fieldManager?: string, _options?: Configuration): Promise<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition> {
        const result = this.api.replaceApiextensionsV1CustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, _options);
        return result.toPromise();
    }
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public watchApiextensionsV1CustomResourceDefinition(name: string, allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1WatchEvent> {
        const result = this.api.watchApiextensionsV1CustomResourceDefinition(name, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options);
        return result.toPromise();
    }
     ...
     * @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
     */
    public watchApiextensionsV1CustomResourceDefinitionList(allowWatchBookmarks?: boolean, _continue?: string, fieldSelector?: string, labelSelector?: string, limit?: number, pretty?: string, resourceVersion?: string, resourceVersionMatch?: string, timeoutSeconds?: number, watch?: boolean, _options?: Configuration): Promise<IoK8sApimachineryPkgApisMetaV1WatchEvent> {
        const result = this.api.watchApiextensionsV1CustomResourceDefinitionList(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch, _options);
        return result.toPromise();
    }
...
export class PromiseVersionApi {
     ...
     */
    public getCodeVersion(_options?: Configuration): Promise<IoK8sApimachineryPkgVersionInfo> {
