<template>
  <div>
      ...
      <div class="i-heroicons-minus-circle"></div>
      ...
      >
        ...
        <div class="px-6 py-4 text-left modal-content">
          ...
          <div class="flex items-center justify-between pb-3">
            <p class="text-2xl font-bold">Delete organization</p>
          ...
          <!--Body-->
          <p>
            Delete organization? This action cannot be undone and will delete all
            associated workspaces and data.
          </p>
          ...
          <div class="relative mt-2 rounded-md shadow-sm">
            <input
              type="text"
              v-model="this.currentOrganizationName"
